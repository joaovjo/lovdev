...
namespace LovDev
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        {
            _Profiles.Add(new UserProfile() { Name = "João", Age = "25", Photo = "AvatarPlaceholder.png" });
            _Profiles.Add(new UserProfile() { Name = "Maria", Age = "20", Photo = "pic_2.jpg" });
            _Profiles.Add(new UserProfile() { Name = "José", Age = "30", Photo = "pic_1.png" });
            _Profiles.Add(new UserProfile() { Name = "Fernando", Age = "18", Photo = "AvatarPlaceholder.png" });
            _Profiles.Add(new UserProfile() { Name = "Sofia", Age = "21", Photo = "pic_2.jpg" });
            _Profiles.Add(new UserProfile() { Name = "Yuno", Age = "20", Photo = "AvatarPlaceholder.png" });
            ...
            _Profiles.Add(new UserProfile() { Name = "Abner", Age = "32", Photo = "AvatarPlaceholder.png" });
            ...
            _Profiles.Add(new UserProfile() { Name = "Janaína", Age = "24", Photo = "AvatarPlaceholder.png" });
